...
The Receive Sync button <img src="https://raw.githubusercontent.com/mendeni/sonobus/refs/heads/1.7.4-gh-actions-opus-combined/images/receive_sync.svg" alt="Receive Sync Icon" width="32">
  synchronizes streams from all remote players by measuring the receive latency from each, noting the largest value, then padding your receive jitter buffer. This will add 2ms. More about <a href="https://raw.githubusercontent.com/mendeni/test/7e33783d8422a24d62ce42cad8a82a11e366a213/images/receive-sync.png">Receive synchronization from a listener perspective</a>.
