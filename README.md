...
The receive sync button <img src="images/receive_sync.svg" alt="Receive Sync Icon" width="16">
  synchronizes streams from all remote players by measuring the receive latency from each, noting the largest value, then padding your receive jitter buffer. More about <a href="images/receive-sync.png">receive synchronization from a listener perspective</a>.
