...
The Receive Sync button <img src="https://raw.githubusercontent.com/mendeni/sonobus/refs/heads/1.7.4-gh-actions-opus-combined/images/receive_sync.svg" alt="Receive Sync Icon" width="64">
  synchronizes streams from all remote players by measuring the receive latency from each, noting the largest value, then padding your receive jitter buffer. This will add 2ms. More about <a href="images/receive-sync.png">Receive synchronization from a listener perspective</a>
